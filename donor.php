      ...
      <div class="row">
        <div class="col-md-3">
          <div class="card" style="width: 16rem">
            ...
            <div class="card-body">
              <h5 class="card-title text-center" style="color:green">Donors</h5>
              ...
              <a id="details-btn" href="inventorydonor.php?group=apos" class="btn btn-primary"
                >Get Blood</a
              >
            </div>
          </div>
        ...
        <div class="col-md-3">
          <div class="card" style="width: 16rem">
            ...
            <div class="card-body">
              ...
              <a id="details-btn" href="inventorydonor.php?group=aneg" class="btn btn-primary"
                >Get Blood</a
              >
            </div>
          </div>
        ...
        <div class="col-md-3">
          <div class="card" style="width: 16rem">
            ...
            <div class="card-body">
              ...
              <a id="details-btn" href="inventorydonor.php?group=bpos" class="btn btn-primary"
                >Get Blood</a
              >
            </div>
          </div>
        ...
        <div class="col-md-3">
          <div class="card" style="width: 16rem">
            ...
            <div class="card-body">
              ...
              <a id="details-btn" href="inventorydonor.php?group=bneg" class="btn btn-primary"
                >Get Blood</a
              >
            </div>
          </div>
        ...
        <div class="col-md-3">
          <div class="card" style="width: 16rem">
            ...
            <div class="card-body">
              ...
              <a id="details-btn" href="inventorydonor.php?group=abpos" class="btn btn-primary"
                >Get Blood</a
              >
            </div>
          </div>
        ...
        <div class="col-md-3">
          <div class="card" style="width: 16rem">
            ...
            <div class="card-body">
              ...
              <a id="details-btn" href="inventorydonor.php?group=abneg" class="btn btn-primary"
                >Get Blood</a
              >
            </div>
          </div>
        ...
        <div class="col-md-3">
          <div class="card" style="width: 16rem">
            ...
            <div class="card-body">
              ...
              <a id="details-btn" href="inventorydonor.php?group=opos" class="btn btn-primary"
                >Get Blood</a
              >
            </div>
          </div>
        ...
        <div class="col-md-3">
          <div class="card" style="width: 16rem">
            ...
            <div class="card-body">
              ...
              <a id="details-btn" href="inventorydonor.php?group=oneg" class="btn btn-primary"
                >Get Blood</a
              >
            </div>
          </div>
